...
```tsx
import { checkOrganizationSlugOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/mutations/check-slug-mutation.ts" name="CheckOrganizationSlugParams" />
