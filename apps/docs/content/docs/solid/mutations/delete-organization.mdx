...
```tsx
import { deleteOrganizationOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/mutations/delete-organization-mutation.ts" name="DeleteOrganizationParams" />
