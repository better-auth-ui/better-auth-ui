...
```tsx
import { createOrganizationOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/mutations/create-organization-mutation.ts" name="CreateOrganizationParams" />
