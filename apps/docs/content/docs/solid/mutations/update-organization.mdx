...
```tsx
import { updateOrganizationOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/mutations/update-organization-mutation.ts" name="UpdateOrganizationParams" />
