...
```tsx
import { listOrganizationsOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/queries/list-organizations-query.ts" name="ListOrganizationsParams" />
