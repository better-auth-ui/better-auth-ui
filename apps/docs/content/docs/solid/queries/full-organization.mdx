...
```tsx
import { fullOrganizationOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/queries/full-organization-query.ts" name="FullOrganizationParams" />
