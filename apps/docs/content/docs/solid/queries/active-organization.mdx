...
```tsx
import { activeOrganizationOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/queries/active-organization-query.ts" name="ActiveOrganizationParams" />
