...
```tsx
import { listUserInvitationsOptions } from "@better-auth-ui/solid/plugins/organization"
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/organization/queries/list-user-invitations-query.ts" name="ListUserInvitationsParams" />
