...
Polar handles cancellation, restoration, and seat changes in its customer portal. BAUI opens the portal for these actions. Stripe uses Better Auth's subscription endpoints.
