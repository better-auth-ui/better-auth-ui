...
<type-table path="../../../../../../examples/start-solid-zaidan-example/src/components/auth/multi-session/switch-account-submenu.tsx" name="SwitchAccountSubmenuProps" />
...
<type-table path="../../../../../../examples/start-solid-zaidan-example/src/components/auth/multi-session/manage-accounts.tsx" name="ManageAccountsProps" />
