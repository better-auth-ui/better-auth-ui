...
<type-table path="../../../../../../packages/core/src/plugins/siwe/siwe-plugin.ts" name="SiwePluginOptions" />

## Localization

<type-table path="../../../../../../packages/core/src/plugins/siwe/siwe-localization.ts" name="SiweLocalization" />
