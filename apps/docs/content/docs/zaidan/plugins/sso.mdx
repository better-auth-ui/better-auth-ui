...
<type-table path="../../../../../../packages/core/src/plugins/sso/sso-plugin.ts" name="SsoPluginOptions" />

## Localization

<type-table path="../../../../../../packages/core/src/plugins/sso/sso-localization.ts" name="SsoLocalization" />
