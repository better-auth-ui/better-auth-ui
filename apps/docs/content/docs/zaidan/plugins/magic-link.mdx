...
<include>../../../shared/ui/plugins/magic-link.mdx#shared-magic-link</include>

<type-table path="../../../../../../examples/start-solid-zaidan-example/src/components/auth/magic-link.tsx" name="MagicLinkProps" />
...
<include>../../../shared/ui/plugins/magic-link.mdx#shared-registry-sent-example</include>

<type-table path="../../../../../../examples/start-solid-zaidan-example/src/components/auth/magic-link-sent.tsx" name="MagicLinkSentProps" />
