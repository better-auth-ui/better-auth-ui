...
```tsx
import { useOAuthContinue } from "@better-auth-ui/react"
...
```ts
import { oauthContinueOptions } from "@better-auth-ui/react"
...
<auto-type-table path="../../../../../../packages/react/src/mutations/oauth-provider/oauth-continue-mutation.ts" name="OAuthContinueParams" />
