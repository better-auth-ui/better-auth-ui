...
<include>../../../shared/mutations/request-phone-number-password-reset.mdx#shared-overview</include>
...
<type-table path="../../../../../../packages/core/src/plugins/phone-number/request-phone-number-password-reset-mutation.ts" name="RequestPhoneNumberPasswordResetParams" />
