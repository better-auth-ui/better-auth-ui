...
```tsx
import { listPasskeysOptions } from "@better-auth-ui/react/plugins/passkey"
...
<auto-type-table path="../../../../../../packages/react/src/plugins/passkey/queries/list-passkeys-query.ts" name="ListPasskeysParams" />
