...
```tsx
import { listDeviceSessionsOptions } from "@better-auth-ui/react/plugins/multi-session"
...
<auto-type-table path="../../../../../../packages/react/src/plugins/multi-session/queries/list-device-sessions-query.ts" name="ListDeviceSessionsParams" />
