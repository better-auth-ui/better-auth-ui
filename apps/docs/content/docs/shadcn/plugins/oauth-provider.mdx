...
description: Add an OAuth 2.1 authorization consent screen to your authentication flow.
---
...
Keep this path aligned with the server's `consentPage`. If your route already resolves plugin paths without an allowlist, no additional route change is needed.
