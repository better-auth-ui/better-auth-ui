...
Polar handles cancellation, restoration, and seat changes in its customer portal. BAUI opens that portal for those actions. Stripe performs them through Better Auth's subscription endpoints.
