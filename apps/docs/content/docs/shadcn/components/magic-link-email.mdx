...
<Demo src="/demos/shadcn/emails/magic-link-email" className="h-[600px]" />
...
<auto-type-table path="../../../../../../packages/react/src/components/emails/magic-link.tsx" name="MagicLinkEmailProps" />
