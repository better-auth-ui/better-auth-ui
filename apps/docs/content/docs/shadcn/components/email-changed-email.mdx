...
<Demo src="/demos/shadcn/emails/email-changed-email" className="h-[740px]" />
...
<auto-type-table path="../../../../../../packages/react/src/components/emails/email-changed.tsx" name="EmailChangedEmailProps" />
