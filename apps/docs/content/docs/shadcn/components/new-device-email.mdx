...
<Demo src="/demos/shadcn/emails/new-device-email" className="h-[840px]" />
...
<auto-type-table path="../../../../../../packages/react/src/components/emails/new-device.tsx" name="NewDeviceEmailProps" />
