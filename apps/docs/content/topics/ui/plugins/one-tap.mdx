...
<type-table doc-variant="heroui shadcn" path="packages/react/src/plugins/one-tap/one-tap-plugin.tsx" name="OneTapPluginOptions" />

<type-table doc-variant="zaidan" path="packages/solid/src/plugins/one-tap/one-tap-plugin.tsx" name="OneTapPluginOptions" />
