...
describe("Solid docs navigation", () => {
  ...
  it("documents only the Solid runtime/package track", () => {
    const expectedPages = [
      ...
      "mutations/request-phone-number-password-reset.mdx",
      "mutations/reset-password-otp.mdx",
      "mutations/reset-password.mdx",
      "mutations/reset-phone-number-password.mdx",
      "mutations/revoke-multi-session.mdx",
      "mutations/revoke-session.mdx",
      "mutations/send-phone-number-otp.mdx",
      ...
      "mutations/sign-in-phone-number.mdx",
      ...
      "mutations/verify-phone-number.mdx",
