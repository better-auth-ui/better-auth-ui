...
describe("Solid auth route component selection", () => {
  ...
  it("wires change password to Solid mutations and account detection like shadcn", () => {
    ...
    expect(changePassword).toContain("onSubmit: async ({ value }) =>")
    expect(changePassword).toContain("passwordsDoNotMatch")
    expect(changePassword).toContain("await changePassword.mutateAsync({")
    ...
    expect(changePassword).toContain("auth.localization.auth.confirmPassword")
    expect(changePassword).toMatch(
      /auth\.localization\.auth\s*\.confirmPasswordPlaceholder/
    )
    expect(changePassword).toContain(
      "auth.localization.settings.updatePassword"
    )
  ...
  it("wires linked accounts to real Solid account queries and link/unlink parity", () => {
    ...
    expect(linkedAccount).toContain("props.account?.id")
    ...
    expect(linkedAccount).toContain("accountId: account.id")
  ...
  it("adds Solid/Zaidan Organization people shell parity", () => {
    ...
    expect(organizationMembers).toContain("createOrganizationTableState")
    expect(organizationMembers).toContain("createOrganizationTable")
    expect(organizationMembers).toContain("OrganizationSortableTableHead")
    expect(organizationMembers).toContain("OrganizationTablePagination")
    expect(organizationMembers).toContain("globalFilterFn")
    expect(organizationMembers).toContain("table.getRowModel().rows")
    expect(organizationMembers).toContain("member.user?.name")
    expect(organizationMembers).toContain("member.user?.email")
    expect(organizationMembers).toContain("setFilterValue")
    expect(organizationMembers).toContain("localization().search")
    expect(organizationMembers).toContain("localization().clear")
    expect(organizationMembers).toContain("manualPagination")
    expect(organizationMembers).toContain("manualFiltering")
    expect(organizationMembers).toContain("manualSorting")
    ...
    expect(organizationMembers).toContain("OrganizationTableBulkAction")
    expect(organizationMembers).toContain("OrganizationTableViewOptions")
    expect(organizationMembers).toContain("OrganizationTableSelectAll")
    ...
    expect(organizationInvitations).toContain("createOrganizationTableState")
    expect(organizationInvitations).toContain("createOrganizationTable")
    expect(organizationInvitations).toContain("OrganizationSortableTableHead")
    expect(organizationInvitations).toContain("OrganizationTablePagination")
    expect(organizationInvitations).toContain("table.getRowModel().rows")
    expect(organizationInvitations).toContain("globalFilterFn")
    expect(organizationInvitations).toContain("setFilterValue")
    ...
    expect(organizationInvitations).toContain("OrganizationTableBulkAction")
    expect(organizationInvitations).toContain("OrganizationTableViewOptions")
    expect(organizationInvitations).toContain("OrganizationTableSelectAll")
