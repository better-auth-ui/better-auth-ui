...
describe("Solid auth route component selection", () => {
  ...
  it("adds Solid/Zaidan Organization people shell parity", () => {
    ...
    expect(organizationMembers).toContain("SortingState")
    expect(organizationMembers).toContain("PaginationState")
    ...
    expect(organizationInvitations).toContain("SortingState")
    expect(organizationInvitations).toContain("PaginationState")
