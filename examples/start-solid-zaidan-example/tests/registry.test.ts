...
describe("Solid registry isolation", () => {
  ...
  it("documents Zaidan quickstart, registry ownership, plugins, and component payloads without skeleton language", () => {
    ...
    expect(organizationRegistry).toContain("OrganizationSortableTableHead")
    expect(organizationRegistry).toContain("OrganizationTablePagination")
    expect(organizationRegistry).toContain("createOrganizationTable")
    expect(organizationRegistry).toContain("SortingState")
    expect(organizationRegistry).toContain("PaginationState")
    ...
    expect(organizationRegistry).toContain("createOrganizationTableState")
    expect(organizationRegistry).toContain("globalFilterFn")
    expect(organizationRegistry).toContain("manualPagination")
    expect(organizationRegistry).toContain("manualSorting")
    expect(organizationRegistry).toContain("table.getRowModel().rows")
    ...
    expect(organizationRegistry).toContain("@tanstack/solid-table")
    expect(organizationRegistry).toContain("OrganizationTableBulkAction")
    expect(organizationRegistry).toContain("OrganizationTableViewOptions")
    expect(organizationRegistry).toContain("OrganizationTableSelectAll")
