import { Admin, AuthProvider, SignIn } from "@better-auth-ui/heroui"
import {
  adminPlugin,
...
function CaptchaStoryWidget({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-xl border p-3">
      ...
      <p aria-live="polite" className="text-center text-muted text-xs">
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <SignIn />
        <p aria-live="polite" className="text-center text-muted text-sm">
          {context}
        </p>
      </div>
    </PluginPreview>
...
const meta = {
  id: "heroui-plugins-complete-coverage",
  title: "HeroUI/Plugins/Authentication helpers",
