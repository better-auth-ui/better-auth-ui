...
/**
 * Get the current session from the query cache, calling `fetchSessionServer` under
 ...
 * `fetchSessionServer`, but does not throw on error and does not return the data —
