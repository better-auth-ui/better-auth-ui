...
describe("Solid plugin subpath exports", () => {
  it("publishes plugin-specific hooks, mutations, and queries from plugin-scoped entrypoints", () => {
    ...
    expect(sso).toHaveProperty("useSsoProvider")
    expect(sso).toHaveProperty("useSsoProviders")
    expect(sso).toHaveProperty("useUpdateSsoProvider")
    expect(sso).toHaveProperty("useDeleteSsoProvider")
    ...
    expect(organization).toHaveProperty("useOrganization")
  ...
  it("keeps core-owned mutation factories out of framework plugin entrypoints", () => {
    ...
    expect(sso).not.toHaveProperty("ssoProvidersOptions")
    expect(sso).not.toHaveProperty("updateSsoProviderOptions")
    expect(sso).not.toHaveProperty("deleteSsoProviderOptions")
    ...
    expect(organization).not.toHaveProperty("organizationOptions")
