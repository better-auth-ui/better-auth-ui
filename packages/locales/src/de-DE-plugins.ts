...
export const deDEPlugins = {
  admin: {
    ...
    banned: "Gesperrt",
    banDuration: "Sperrdauer (Tage)",
    banDurationDescription: "Leer lassen, um dauerhaft zu sperren.",
    banExpires: "Gesperrt bis",
    banReason: "Grund der Sperre",
    ...
    overview: "Übersicht",
    password: "Passwort",
    profileAndAccess: "Profil und Zugriff",
    retry: "Erneut versuchen",
    role: "Rolle",
    search: "Suche",
    searchContains: "Enthält",
    searchOperator: "Suchoperator",
  ...
  organization: {
    ...
    cancelSelectedInvitations: "Ausgewählte Einladungen abbrechen",
    cancelSelectedInvitationsDescription:
      "Möchtest du die ausgewählten ausstehenden Einladungen abbrechen?",
    invitationsCanceled: "{{count}} Einladungen abgebrochen",
    removeSelectedMembers: "Ausgewählte Mitglieder entfernen",
    removeSelectedMembersDescription:
      "Möchtest du die ausgewählten Mitglieder aus dieser Organisation entfernen? Der Zugriff geht sofort verloren.",
    membersRemoved: "{{count}} Mitglieder entfernt",
    deleteSelectedRoles: "Ausgewählte Rollen löschen",
    deleteSelectedRolesDescription:
      "Möchtest du die ausgewählten Rollen löschen? Rollen, die Mitgliedern zugewiesen sind, können nicht gelöscht werden.",
    rolesDeleted: "{{count}} Rollen gelöscht",
    ...
    role: "Rolle",
    search: "Suchen...",
    selectAtLeastOneRole: "Wähle mindestens eine Rolle aus.",
